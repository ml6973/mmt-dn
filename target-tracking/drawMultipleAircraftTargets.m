function drawMultipleAircraftTargets(uu,V,F,colors,map,R_min,cam_fov,NOU,NOT,Vt,Ft)
%NOU=3;
...
for i=1:NOU
    ...
    pn(i)       = uu(14*(i-1)+1);       % inertial North position
    pe(i)       = uu(14*(i-1)+2);       % inertial East position
