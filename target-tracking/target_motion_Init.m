function [sys,x0,str,ts] = target_motion_Init(t,x,u,flag,P,map,z0,v0)
...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%
  case 0,
    [sys,x0,str,ts]=mdlInitializeSizes(P,map,z0,v0);
...
%=============================================================================
%
function [sys,x0,str,ts]=mdlInitializeSizes(P,map,z0,v0)
...
%vel = [P.target_velocity; 0; 0]; %% keeps velocity always in x direction
    sys = [vel; z_last];
