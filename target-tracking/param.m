...
P.pn0    = 0;  % initial North position
P.pe0    = 0;  % initial East position
P.pd0    = -80;  % initial Down position (negative altitude)
...
P.sigma_measurement_n = 10; % standard deviation of gps measurement error in m
P.sigma_measurement_e = 10; % standard deviation of gps measurement error in m
P.sigma_measurement_h =10; % standard deviation of gps measurement error in m
